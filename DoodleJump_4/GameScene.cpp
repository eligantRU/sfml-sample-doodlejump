...
CGameScene::CGameScene(sf::RenderWindow & window, CAssets & assets)
	:m_window(window)
	,m_assets(assets)
	,m_hero(m_assets)
{
...
void CGameScene::CheckKeyPressed(const sf::Event & event, bool & isNeedUpdate)
{
...
void CGameScene::CheckKeyReleased(const sf::Event & event, bool & isNeedUpdate)
{
...
void CGameScene::CheckCylinderEffect()
{
...
void CGameScene::GeneratePlates()
{
...
unsigned CGameScene::GetUppermostPlateIndex() const
{
...
void CGameScene::BuildPlate(const unsigned basePlateID, const unsigned replacingPlateID)
{
...
sf::Vector2f CGameScene::GetCenterPlatePosition(const unsigned plateID) const
{
